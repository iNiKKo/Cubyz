...
pub const debug_settings = @import("debug_settings.zig");
...
pub const editor_toolbar = @import("editor_toolbar.zig");
pub const editor_details_panel = @import("editor_details_panel.zig");
pub const editor_content_browser = @import("editor_content_browser.zig");
